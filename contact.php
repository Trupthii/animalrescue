...
<!-- site metas -->
<title>Animal Rescue | Contact</title>
                    ...
                    <div class="input_main">
                       <div class="container">
                          <form action="Controller/contactForm.php" method="post">
                            ...
                            <div class="form-group">
                              <input type="text" required class="email-bt" placeholder="Enter Your Phone Numbar" name="phone">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <textarea required class="massage-bt" placeholder="Enter Message" rows="5" id="comment" name="message"></textarea>
                            </div>
