...
<body>
  ...
  <div class="  ">
    <div class="container">
     <h1 style="float:right;" class=""><span style="color: #f7941d;font-family: 'Roboto',sans-serif;">Success</span> Story </h1>
        <hr>
        <br>
        <br>
        <br>
        ...
        <div class="container">
         <?php
             	$token = $_GET['token'];
                    ...
                    ?>
                    <center> <img class="" style="border-radius:50px 25px" src="Controller/<?= $getData['posterfile']?>" height="350px" width="350px" alt="Bologna">
                    </center>
                   <br>   <small style="" class="text-muted cat">
                            <i class="far fa-clock text-info"></i> <?= $getData['date']?>
                        </small> <br> <br>
                   <h3><?= $getData['title']?></h3> <hr>
                   <?= $getData['blog']?>
    ...
    <div class="section_footer">
    	<div class="container">
    		<div class="mail_section">
    			<ul>
    				<li class="footer-logo"><img src="images/logo.png"><span style="position:relative;top:42px;left:-33px;"><span style="color:orange;font-size:20px;font-weight:bold;">A - </span> <span style="color:orange;font-size:20px;font-weight:bold;">Rescue</span>  </span>s</li>
    	    ...
    	    <div class="footer_section_2">
		        <div class="row">
    		        <div class="col-sm-6 col-md-6 col-lg-3">
    		        	...
    		        	<p class="dummy_text">Writer,environmentalist and a humane individual,tauseef is an inspiration to all,known as 'mr.Rescuer' he haas been working relentlessly to rescue animals in trouble in and around mangalore  </p>
    		        </div>
    		        <div class="col-sm-6 col-md-6 col-lg-3">
