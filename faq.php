...
<body>
  ...
  <div class="  ">
    <div class="container">
     <h1 style="float:right;" class=""><strong><span style="color: #f7941d;">FAQ</span></strong></h1>
        <hr>
        <br>
        <br>
        <br>
        ...
        <br>
         <?php
                    ...
                    $qno = 0; 
                        ...
                        $fetchData = $database->getReference('faq/')
    						->getValue();
		  ...
		  <div class="panel-heading p-3 mb-3" role="tab" id="heading1">
			<h3 class="panel-title">
			  <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#<?= $i?>" aria-expanded="true" aria-controls="collapse1">
				<b><?= ++$qno?></b>. <?= $row['faqQ']?>
			  </a>
			</h3>
		  </div>
		  <div id="<?= $i?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading1">
    	...
    	<div class="container">
    		<div class="mail_section">
    			<ul>
    				...
    				<li class="footer-logo"><img src="images/call-icon.png"><span class="map_text">6982424536</span></li>
