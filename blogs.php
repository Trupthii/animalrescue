...
<body>
  ...
  <div class="  ">
    <div class="container">
     <h1 style="float:right;" class=""><strong><span style="color: #f7941d;">Success Stories</span> </strong></h1>
        <hr>
        <br>
        <br>
        <br>
        ...
        <div class="container">
         ...
         <?php
                    $i = 0; 
                        ...
                        $fetchData = $database->getReference('blog/')
    						->getValue();
                   ...
                   <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img" src="Controller/<?= $row['posterfile']?>" height="250px" width="250px" alt="Bologna">
                       
                        <div class="card-body">
                        <h4 class="card-title"><?= $row['title']?></h4>
                        <small class="text-muted cat">
                            <i class="far fa-clock text-info"></i> <?= $row['date']?>
                        </small> <br>
                       <a href="viewblog.php?token=<?= $key?>" class="btn btn-info">Read Stories</a>
                        </div>
    	...
    	<div class="container">
    		<div class="mail_section">
    			<ul>
    				...
    				<li class="footer-logo"><img src="images/call-icon.png"><span class="map_text"> 56982424536</span></li>
