...
<!-- site metas -->
<title>Animal Rescue | Lost and Found</title>
...
<body>
						...
						<ul>
							...
							<li class="active">
                             ...
                             <div class="overlay-content">
                                ...
                                <a href="ladf.php">Lost and Found</a>
								<?phpd
								if(isset($_SESSION['id'])){ 
  ...
  <div class="  ">
    <div class="container">
     <h1 style="float:right;" class=""><strong><span style="color: #f7941d;">Lost and Found</span></strong></h1>
        <hr>
        <br>
        <br>
        <br>
        ...
        <div class="row">
         <?php
                    $i = 0; 
                        ...
                        $fetchData = $database->getReference('lostAndFound/')
    						->getValue();
                    ...
                    ?>
                     <div class="card col-md-4" style="">
                       <center> <img class="card-img-top" src="Controller/<?= $row['petImage']?>" alt="Card image" style="height:300px;width:300px">
                      </center>  <div class="card-body">
                        <p class="card-text">Lost Location : <?= $row['lostLocation']?></p>
                        <p class="card-text">Owner Name : <?= $row['name']?></p>
                        <p class="card-text">Owner Contact Number : <?= $row['phone']?></p>
